  ...
  return (
    <div className="h-[calc(100vh-70px)] w-screen flex flex-col items-center justify-center overflow-hidden rounded-md z-20">
      ...
      <div className="flex gap-6 mt-20 flex-col md:flex-row items-center">
        <div className="bg-white w-max text-black px-4 md:px-8 py-4 rounded-lg text-lg md:text-xl font-semibold cursor-pointer">
        ...
        <div className="px-2 md:px-8 py-4 rounded-lg text-lg md:text-xl cursor-pointer hover:text-neutral-300">
