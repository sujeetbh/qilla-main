...
export function Hero() {
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center overflow-hidden rounded-md z-20">
      ...
      <h1 className="relative text-6xl md:text-8xl text-neutral-300 text-center font-sans font-bold">
      ...
      <div className="flex gap-6 mt-20 flex-col md:flex-row items-center">
        <div className="bg-white w-max text-black px-4 md:px-8 py-4 rounded-lg text-xl font-semibold flex items-center gap-2 cursor-pointer">
          <span>Secure NFTs</span>
          <ArrowUpRight />
        </div>
        <div className="px-2 md:px-8 py-4 rounded-lg text-xl flex gap-2 items-center cursor-pointer hover:text-neutral-300">
