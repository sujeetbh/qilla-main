...
export function Hero() {
  ...
  return (
    <div className="h-[calc(100vh-70px)] w-screen flex flex-col items-center justify-center overflow-hidden rounded-md z-20">
      ...
      <p className="text-lg md:text-2xl mt-1 text-neutral-300 text-center font-sans">{heroValue && heroValue[0] ? heroValue[0].subtitle : heroData.subtitle}</p>
      <p className="text-lg md:text-2xl mt-1 text-neutral-300 text-center font-sans">{heroValue && heroValue[0] ? heroValue[0].description : heroData.description}</p>
